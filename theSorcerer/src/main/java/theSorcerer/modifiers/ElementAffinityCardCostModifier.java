...
public class ElementAffinityCardCostModifier extends AbstractCardModifier implements AlternateCardCostModifier {
    ...
    public AbstractCardModifier makeCopy() {
        return new ElementAffinityCardCostModifier();
    }
}
