...
public class ArcaneCometsEffect extends AbstractGameEffect {
    ...
    private void playRandomSfX() {
        if (this.element == Element.FIRE) {
            ...
            CardCrawlGame.sound.playA("ORB_FROST_EVOKE", -0.3F);
        }
        else {
            CardCrawlGame.sound.playA("ORB_PLASMA_EVOKE", -0.3F);
        }
